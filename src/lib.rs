...
use libsufr::{
    ...
    types::{
        SufrBuilderArgs, SequenceFileData,
    },
...
impl PySequenceFileData {
    ...
    //         sequence_file_data: sequence_file_data
    //     })
    // }
...
impl PySuffixArray {
    ...
    pub fn new(args: PySufrBuilderArgs) -> PyResult<PySuffixArray> {
        ...
        //SuffixArray::read(&path, low_memory).unwrap()
        Ok(PySuffixArray {
            suffix_array: SuffixArray::read(&path, low_memory).unwrap()
        })
    }
    // pub fn write(args: PySufrBuilderArgs) -> PyResult<String> {
    //     Ok(SuffixArray::write(args.sufr_builder_args).unwrap())
    // }
    // pub fn read(filename: &str, low_memory: bool) -> PyResult<PySuffixArray> {
    //     Ok(PySuffixArray { 
    ...
    //         .unwrap()
    //         .iter()
    //         .map(|cr| PyCountResult{ count_result: cr})
    //         .collect()
    //     )
    // }
